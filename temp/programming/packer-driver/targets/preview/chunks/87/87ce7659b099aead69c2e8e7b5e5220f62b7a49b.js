    ...
    execute: function () {
      ...
      _export("level2_science", level2_science = (_dec = ccclass('level2_science'), _dec2 = property({
        ...
        initGraphic() {
          ...
          this.draw = gNode; // this.area.addChild(this.draw);    

          var g = instantiate(graphicsPrefab).getComponent(Graphics);
...
//# sourceMappingURL=87ce7659b099aead69c2e8e7b5e5220f62b7a49b.js.map