System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, Color, log, Prefab, tween, v3, VDScreenManager, ScaleFactor, scaleTo, TimeFactor, level_progress_bar, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, level1_comp;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        onClickInstruction() {
          if (this.progressLevelBar) {
            this.progressLevelBar.handleProgress();
        ...
        startPlay() {
          this.progressLevelBar = this.levelBarUI;
...
//# sourceMappingURL=135c2462add90da6f160eaff78cafb355287644b.js.map