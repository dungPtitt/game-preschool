  ...
  return {
    ...
    execute: function () {
      ...
      _export("level4_science", level4_science = (_dec = ccclass('level4_science'), _dec2 = property(_crd && level_progress_bar === void 0 ? (_reportPossibleCrUseOflevel_progress_bar({
        ...
        initDrawInstruction() {
          // ve tu 1->9
          var p1 = this.listDots[0].getWorldPosition();
          var p2 = this.listDots[8].getWorldPosition();
          var out = v3();
        ...
        checkPositionSrc() {
          ...
          var startPosSrc = this.startP.getWorldPosition();
          var dx = Math.abs(startPosSrc.x - this.startPosUI.x);
          var dy = Math.abs(startPosSrc.y - this.startPosUI.y);
        ...
        checkPositionDes() {
          var pDes = this.endP.getWorldPosition();
          var dx = Math.abs(this.endPosUI.x - pDes.x);
          var dy = Math.abs(this.endPosUI.y - pDes.y);
...
//# sourceMappingURL=1375e033fafab9fde6ea5f3ec414643459771530.js.map