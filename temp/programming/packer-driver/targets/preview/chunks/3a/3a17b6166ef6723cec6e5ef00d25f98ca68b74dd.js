  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", VDScrollBar = (_dec = property(cc.Sprite), _dec2 = property(_crd && VDScrollView === void 0 ? (_reportPossibleCrUseOfVDScrollView({
        ...
        updateBackground() {
          if (this.scrollView) {
            ...
            if (this.direction == VDScrollBarDirection.VERTICAL) {
              ...
              var x = this.scrollView.node.getComponent(cc.UITransform).width * (1 - this.scrollView.node.getComponent(cc.UITransform).anchorX) - this.node.getComponent(cc.UITransform).width * (1 - this.node.getComponent(cc.UITransform).anchorX) * this.node.getScale().x;
              var y = this.scrollView.node.getComponent(cc.UITransform).height * (1 - this.scrollView.node.getComponent(cc.UITransform).anchorY) - this.node.getComponent(cc.UITransform).height * (1 - this.node.getComponent(cc.UITransform).anchorY) * this.node.getScale().y;
              this.node.setPosition(x, y);
            } else if (this.direction == VDScrollBarDirection.HORIZONTAL) {
              //set background position at the bottom of the view
              this.node.angle = 90;

              var _x = this.scrollView.node.getComponent(cc.UITransform).width * (1 - this.scrollView.node.getComponent(cc.UITransform).anchorX) - this.node.getComponent(cc.UITransform).height * (1 - this.node.getComponent(cc.UITransform).anchorY) * this.node.getScale().y;

              var _y = -this.scrollView.node.getComponent(cc.UITransform).height * this.scrollView.node.getComponent(cc.UITransform).anchorY + this.node.getComponent(cc.UITransform).width * (1 - this.node.getComponent(cc.UITransform).anchorX) * this.node.getScale().x;
        ...
        updateScrollBar() {
          var factor = Math.min(this.scrollView.node.getComponent(cc.UITransform).height / this.scrollView.content.getComponent(cc.UITransform).height, 1); // let scrollRatio = this.
          ...
          if (this.direction == VDScrollBarDirection.VERTICAL) {
            var x = this.node.getComponent(cc.UITransform).width * (1 - this.node.getComponent(cc.UITransform).anchorX) - this.bar.node.getComponent(cc.UITransform).width * (1 - this.bar.node.getComponent(cc.UITransform).anchorX) * this.bar.node.getScale().x;
            var y = this.node.getComponent(cc.UITransform).width * (1 - this.node.getComponent(cc.UITransform).anchorX) - this.bar.node.getComponent(cc.UITransform).width * (1 - this.bar.node.getComponent(cc.UITransform).anchorX) * this.bar.node.getScale().x;
...
//# sourceMappingURL=3a17b6166ef6723cec6e5ef00d25f98ca68b74dd.js.map