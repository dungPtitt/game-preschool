      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        processCorrect() {
          ...
          (_crd && scaleAndHide === void 0 ? (_reportPossibleCrUseOfscaleAndHide({
            error: Error()
          }), scaleAndHide) : scaleAndHide)(this.fireWork, v3(1, 1, 0), 3, this.showPopupNext);
        ...
        showPopupNext() {
          // log("popupnext", this.popupNext)
          (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
          }), VDScreenManager) : VDScreenManager).instance.showPopupFromPrefabName("res/prefabs/popup/popup_next", popup => {
            var popupWin = popup; // this.popupNext = true;

            log("check popup", popupWin); // this.popupNext = popupWin;
          ...
          }, false, true, false); // if(!this.popupNext) {
          // }
        }
...
//# sourceMappingURL=51984a4a7fbe41d931dcec0cc81a6467751ad032.js.map