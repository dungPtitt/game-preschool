System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, Color, log, Prefab, tween, v3, Label, Button, UIOpacity, VDScreenManager, ScaleFactor, scaleTo, TimeFactor, level_progress_bar, LocalDataManager, scaleAndHide, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, level1_comp;
    ...
    execute: function () {
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        start() {
          ...
          var btn = this.btnHome.getComponent(Button);
          btn.onDisable();
          this.btnHome.getComponent(UIOpacity).opacity = 100;
          this.startPlay();
        }
...
//# sourceMappingURL=6840836c9f72e7434515bc890bf569332ac0a728.js.map