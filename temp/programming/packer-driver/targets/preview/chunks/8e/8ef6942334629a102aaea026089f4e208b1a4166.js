    ...
    execute: function () {
      ...
      _export("level2_science", level2_science = (_dec = ccclass('level2_science'), _dec2 = property({
        ...
        onTouchStart(event) {
          ...
          var pLeft = this.left.getWorldPosition();
          this.pStart = v2(pLeft.x, pLeft.y); // gan vi tri bat dau ve

          var p = event.getUILocation();
          this.currentStart = v2(p.x, p.y); // xu ly ve
        ...
        onTouchEnd(event) {
          ...
          var dx = Math.abs(this.pStart.x - this.currentStart.x);
          var dy = Math.abs(this.pStart.y - this.currentStart.y);
...
//# sourceMappingURL=8ef6942334629a102aaea026089f4e208b1a4166.js.map