System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, log, Prefab, tween, v3, Label, Button, UIOpacity, VDScreenManager, scaleTo2, level_progress_bar, LocalDataManager, scaleAndHide, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, level2_comp;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("level2_comp", level2_comp = (_dec = ccclass('level2_comp'), _dec2 = property({
        ...
        onClickInstruction() {
          tween().to(3, this.answer.getComponent(UIOpacity).opacity = 100).call(() => {
        ...
        processCorrect(i) {
          ...
          (_crd && scaleTo2 === void 0 ? (_reportPossibleCrUseOfscaleTo({
            error: Error()
...
//# sourceMappingURL=c1f7d56a7e79becedf4b47e62aee187cfb93c7e4.js.map