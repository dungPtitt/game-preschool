    ...
    execute: function () {
      ...
      _export("level1_match", level1_match = (_dec = ccclass('level1_match'), _dec2 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "itemAnswer", _descriptor2, this);
        }
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "itemAnswer", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=7b724ecafee38fb7e0d24dfb4907ba39208ad2da.js.map