  ...
  return {
    ...
    execute: function () {
      ...
      _export("dm_Scene", dm_Scene = (_dec = ccclass('dm_Scene'), _dec(_class = class dm_Scene extends Component {
        onLoad() {
          log("@ dm_Scene: onLoad  !!!");
          var bundle = assetManager.getBundle("bundle_" + (_crd && dm_Config === void 0 ? (_reportPossibleCrUseOfdm_Config({
            error: Error()
...
//# sourceMappingURL=fb1d55ff8c3bc848bc9f8a0bb19975e4d6142170.js.map