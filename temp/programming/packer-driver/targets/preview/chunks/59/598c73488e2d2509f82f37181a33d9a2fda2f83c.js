System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, log, tween, v3, VDScreenManager, LocalDataManager, level_progress_bar, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, level1_picture;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Prefab', 'log', 'Sprite', 'tween', 'v3']);
      ...
      _export("level1_picture", level1_picture = (_dec = ccclass("level1_picture"), _dec2 = property({
        ...
        checkPosition(i) {
          ...
          var dy = Math.abs(answerP.y + 50 - questionP.y); // log("check i: ", dx, dy);
        ...
        showPopupNext() {
          ...
          (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            ...
            popupWin.finishedCallback = () => {
              var levelNext_screen = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
                error: Error()
        ...
        handleCorrect() {
          ...
          var currentLevel = obCheck.picture[this.levelNumber];

          if (!currentLevel) {
            this.levelBarUI.handleProgress();
          }

          obCheck.picture[this.levelNumber] = true;
...
//# sourceMappingURL=598c73488e2d2509f82f37181a33d9a2fda2f83c.js.map