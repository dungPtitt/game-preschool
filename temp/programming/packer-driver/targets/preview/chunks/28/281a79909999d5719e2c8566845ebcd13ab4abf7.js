    ...
    execute: function () {
      ...
      _export("level4_science", level4_science = (_dec = ccclass('level4_science'), _dec2 = property(_crd && level_progress_bar === void 0 ? (_reportPossibleCrUseOflevel_progress_bar({
        ...
        start() {
          ...
          this.area.addChild(this.draw); // this.draw.on(Node.EventType.TOUCH_START, this.onTouchStart.bind(this));
...
//# sourceMappingURL=281a79909999d5719e2c8566845ebcd13ab4abf7.js.map