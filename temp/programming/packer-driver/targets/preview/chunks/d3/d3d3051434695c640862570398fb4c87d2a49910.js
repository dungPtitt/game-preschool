    ...
    execute: function () {
      ...
      _export("level1_match", level1_match = (_dec = ccclass('level1_match'), _dec2 = property({
        ...
        checkPosition(itemMoving, i) {
          ...
          for (var j = 0; j < this.itemAnswers.length; j++) {// let answerP = this.itemAnswers[i].getWorldPosition();
...
//# sourceMappingURL=d3d3051434695c640862570398fb4c87d2a49910.js.map