    ...
    execute: function () {
      ...
      _export("level1_science", level1_science = (_dec = ccclass('level1_science'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class level1_science extends Component {
        ...
        start() {
          ...
          var quesP = this.left.getWorldPosition();
          this.questionP = v2(quesP.x, quesP.y);
          var ansP = this.right.getWorldPosition();
        ...
        touchStart(event) {
          var startPo = this.left.getWorldPosition();
          var endP = this.right.getWorldPosition();
          log("check before and after: ", startPo, this.questionP);
          var pStart = event.getUILocation(); // this.startP = v2(startPo.x, startPo.y);
        ...
        touchEnd(event) {
          ...
          if (this.isDrawFirst) {
            ...
            var dx = Math.abs(this.startP.x - this.leftP.x);
            var dy = Math.abs(this.startP.y - this.leftP.y);
...
//# sourceMappingURL=1d6772acfd569ea9fd11f53517594d2aec04a724.js.map