  ...
  return {
    ...
    execute: function () {
      ...
      _export("level4_science", level4_science = (_dec = ccclass('level4_science'), _dec2 = property(_crd && level_progress_bar === void 0 ? (_reportPossibleCrUseOflevel_progress_bar({
        ...
        checkPosition() {
          log("compare: ", this.startPosUI, this.listDots[0].getWorldPosition());
          var startPosSrc = this.listDots[0].getWorldPosition();
...
//# sourceMappingURL=0e066d36c80cd09112291f5e88330d3ff97ec23a.js.map