    ...
    execute: function () {
      ...
      _export("level1_science", level1_science = (_dec = ccclass('level1_science'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class level1_science extends Component {
        ...
        initGraphic() {
          ...
          var startP = this.left.getPosition();
          var endP = this.right.getPosition(); // log("check endP", endP, startP);
        ...
        touchStart(event) {
          var startP = this.left.getPosition();
          var endP = this.right.getPosition();
...
//# sourceMappingURL=7a8495c7f0bd422b8a93541f429ffcaf980d4f93.js.map