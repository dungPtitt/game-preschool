    ...
    execute: function () {
      ...
      _export("level1_match", level1_match = (_dec = ccclass('level1_match'), _dec2 = property({
        ...
        checkPosition(itemMoving, i) {
          log("check i: ", itemMoving, i); // let questionP = itemMoving.getWorldPosition();

          for (var j = 0; j < this.itemAnswers.length; j++) {// let answerP = this.itemAnswers[j].getWorldPosition();
...
//# sourceMappingURL=9bc914fa4507c543d3abcec37961a73760d3f498.js.map