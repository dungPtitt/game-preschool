    ...
    execute: function () {
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        start() {
          ...
          log("check >>", this.levelNumber + 1); // let checkDone = LocalDataManager.getObject("check", {});
          ...
          (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            ...
            popupWin.finishedCallback = () => {
              ...
              var level2_screen = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
                error: Error()
              }), VDScreenManager) : VDScreenManager).instance.assetBundle.get('res/prefabs/screen/comparison/level' + String(this.levelNumber), Prefab);
              (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
                error: Error()
...
//# sourceMappingURL=0aa123b0f15beff74c69b1342f7a91a0ddb791a1.js.map