System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'Color', 'log', 'Prefab', 'tween', 'v3', 'Label', 'Vec3', 'Button', 'UIOpacity', 'EventTouch', 'Graphics', 'v2', 'Vec2', 'AssetManager', 'resources']);
      ...
      _export("level2_science", level2_science = (_dec = ccclass('level2_science'), _dec2 = property({
        ...
        initGraphic() {
          this.assetBundle.load('res/prefabs/common/draw', Prefab);
          var nodeGraphics = this.assetBundle.get('res/prefabs/common/draw', Prefab);
          log("check prefab: ", nodeGraphics);
          this.graphics = nodeGraphics;
...
//# sourceMappingURL=fcbbccd575851ae3283228d3395c82851fe06b12.js.map