System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, Color, log, Prefab, VDScreenManager, ScaleFactor, scaleTo, TimeFactor, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, level1_comp;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'Color', 'log', 'Prefab']);
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        onClickInstruction() {
          ...
          var p = this.answer.getWorldPosition();
          this.pointer.setWorldPosition(p.x, p.y, 0); // let sprite =  this.answer.getComponent(Sprite);
...
//# sourceMappingURL=64da3bd526693564a91a35cad4b53e26f15ef9fc.js.map