System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, log, Prefab, VDScreenManager, LocalDataManager, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, ex_ComparisonScreen;
    ...
    execute: function () {
      ...
      _export("ex_ComparisonScreen", ex_ComparisonScreen = (_dec = ccclass('ex_ComparisonScreen'), _dec2 = property(Node), _dec(_class = (_class2 = class ex_ComparisonScreen extends Component {
        ...
        canPlayLevel() {
          ...
          var checkDone = ob.comparison;

          for (var i = 0; i < this.listLevel.length; i++) {
            if (checkDone[i + 1]) {
              // khong the choi
              var btnLevel = this.listLevel[i];
              log("check btn: ", btnLevel); // let btn = btnLevel.getComponent(Button);
              // btn.onDisable();
...
//# sourceMappingURL=3c494789f2536c37e345638fd309ecc527f73ee0.js.map