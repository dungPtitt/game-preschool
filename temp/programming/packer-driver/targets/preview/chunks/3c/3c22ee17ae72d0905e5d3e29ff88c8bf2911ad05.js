System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, ProgressBar, Label, AudioClip, assetManager, Prefab, sys, _decorator, Component, log, VDAudioManager, VDLocalDataManager, VDScreenManager, dm_Config, dm_Director, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, dm_LoadingScreen;
  ...
  function _reportPossibleCrUseOfdm_Director(extras) {
    _reporterNs.report("dm_Director", "../common/dm_Director", _context.meta, extras);
  }

  function _reportPossibleCrUseOfdm_PlayScreen(extras) {
    _reporterNs.report("dm_PlayScreen", "./dm_PlayScreen", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      dm_Director = _unresolved_6.dm_Director;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "c873cRjKctEv683Yx2LVe7F", "dm_LoadingScreen", undefined);

      __checkObsolete__(['ProgressBar']);

      __checkObsolete__(['Label']);

      __checkObsolete__(['AudioClip', 'assetManager', 'Asset', 'Button', 'utils', 'sp', 'Prefab', 'tween', 'Vec3']);
      ...
      _export("dm_LoadingScreen", dm_LoadingScreen = (_dec = ccclass('dm_LoadingScreen'), _dec2 = property(ProgressBar), _dec3 = property(Label), _dec(_class = (_class2 = class dm_LoadingScreen extends Component {
        constructor() {
          super(...arguments);
        ...
        onLoad() {
          ...
          var prefabs = ['res/prefabs/transition/transition_cloud', 'res/prefabs/screen/play_screen', 'res/prefabs/screen/play_screen_2', 'res/prefabs/screen/play_screen_3'];
          ...
          this._setVersion((_crd && dm_Config === void 0 ? (_reportPossibleCrUseOfdm_Config({
            error: Error()
          }), dm_Config) : dm_Config).versionGame);
        }
        ...
        onClickBtn2MainGame() {
          ...
          (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            ...
            (_crd && dm_Director === void 0 ? (_reportPossibleCrUseOfdm_Director({
              error: Error()
            }), dm_Director) : dm_Director).instance.playScreen = screen;
          });
        }
...
//# sourceMappingURL=3c22ee17ae72d0905e5d3e29ff88c8bf2911ad05.js.map