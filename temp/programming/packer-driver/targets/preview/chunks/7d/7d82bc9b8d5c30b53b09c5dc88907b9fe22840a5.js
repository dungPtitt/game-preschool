System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Color, log, Prefab, tween, v3, Label, Graphics, v2, resources, instantiate, VDScreenManager, level_progress_bar, LocalDataManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, level2_science;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'Color', 'log', 'Prefab', 'tween', 'v3', 'Label', 'Vec3', 'Button', 'UIOpacity', 'EventTouch', 'Graphics', 'v2', 'Vec2', 'AssetManager', 'resources', 'instantiate']);
      ...
      _export("level2_science", level2_science = (_dec = ccclass('level2_science'), _dec2 = property({
        ...
        type: Node
      }), _dec10 = property(_crd && level_progress_bar === void 0 ? (_reportPossibleCrUseOflevel_progress_bar({
        error: Error()
      }), level_progress_bar) : level_progress_bar), _dec11 = property(Node), _dec(_class = (_class2 = class level2_science extends Component {
        constructor() {
          super(...arguments);
          this.assetBundle = resources;

          _initializerDefineProperty(this, "area", _descriptor, this);

          _initializerDefineProperty(this, "listAnswers", _descriptor2, this);

          _initializerDefineProperty(this, "listQuestion", _descriptor3, this);

          _initializerDefineProperty(this, "smile", _descriptor4, this);

          _initializerDefineProperty(this, "cry", _descriptor5, this);

          _initializerDefineProperty(this, "fireWork", _descriptor6, this);

          _initializerDefineProperty(this, "left", _descriptor7, this);

          _initializerDefineProperty(this, "right", _descriptor8, this);

          _initializerDefineProperty(this, "levelBarUI", _descriptor9, this);
        ...
        initGraphic() {
          var graphicsPrefab = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
          }), VDScreenManager) : VDScreenManager).instance.assetBundle.get('res/prefabs/common/draw', Prefab);
          var gNode = instantiate(graphicsPrefab);
          this.draw = gNode;
          var g = instantiate(graphicsPrefab).getComponent(Graphics); // log("check draw: ", g.getComponent(Graphics), this.draw.getComponent(Graphics));

          g.strokeColor = Color.BLACK; // g.fillColor = Color.WHITE;
        ...
        onTouchStart(event) {
          if (this.firstOne) {
            ...
            var pRight = this.right.getWorldPosition();
          ...
          var g = this.listGraphics[this.listGraphics.length - 1];
        ...
        handleDrawContinue() {
          this.initGraphic();
          var g = this.listGraphics[this.listGraphics.length - 1];
          log("check arr graphic: ", this.listGraphics); //quy doi ve cung toa do
        ...
        checkAnswer() {
          if (this.canPlay) {
            var dx = Math.abs(this.pTarget.x - this.pTemp.x);
            var dy = Math.abs(this.pTarget.y - this.pTemp.y);
        ...
        processCorrect() {
          ...
          var checkDone = ob.science[this.levelNumber + 1];
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "listQuestion", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "smile", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "cry", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "left", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "right", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "levelBarUI", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "level", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=7d82bc9b8d5c30b53b09c5dc88907b9fe22840a5.js.map