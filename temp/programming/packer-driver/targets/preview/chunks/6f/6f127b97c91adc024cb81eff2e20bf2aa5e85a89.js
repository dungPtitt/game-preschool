    ...
    execute: function () {
      ...
      _export("level1_match", level1_match = (_dec = ccclass('level1_match'), _dec2 = property({
        ...
        handleCorrect() {
          ...
          var arrLevelMatch = (_crd && LocalDataManager === void 0 ? (_reportPossibleCrUseOfLocalDataManager({
            error: Error()
          }), LocalDataManager) : LocalDataManager).getObject("check", {});
          var currentLevel = arrLevelMatch.match[this.levelNumber];
...
//# sourceMappingURL=6f127b97c91adc024cb81eff2e20bf2aa5e85a89.js.map