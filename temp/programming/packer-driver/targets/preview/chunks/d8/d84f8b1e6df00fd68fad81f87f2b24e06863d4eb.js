System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Sprite, Color, log, Prefab, tween, v3, Label, VDScreenManager, ScaleFactor, scaleTo, TimeFactor, level_progress_bar, LocalDataManager, handleFirework, scaleAndHide, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, level1_comp;
  ...
  function _reportPossibleCrUseOfhandleFirework(extras) {
    _reporterNs.report("handleFirework", "../../common/handleFirework", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      handleFirework = _unresolved_6.handleFirework;
    }, function (_unresolved_7) {
      scaleAndHide = _unresolved_7.scaleAndHide;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'Color', 'log', 'Prefab', 'tween', 'v3', 'Label', 'Vec3']);
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        type: _crd && handleFirework === void 0 ? (_reportPossibleCrUseOfhandleFirework({
          error: Error()
        ...
        error: Error()
      }), level_progress_bar) : level_progress_bar), _dec10 = property({
        type: Node
      }), _dec11 = property(Node), _dec(_class = (_class2 = class level1_comp extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "fireWorkL", _descriptor6, this);

          _initializerDefineProperty(this, "fireWorkR", _descriptor7, this);
        ...
        start() {
          ...
          var checkDone = (_crd && LocalDataManager === void 0 ? (_reportPossibleCrUseOfLocalDataManager({
            error: Error()
          }), LocalDataManager) : LocalDataManager).getObject("check", {});
          var check = checkDone.comparison[this.levelNumber];
          this.canPlay = !check;
          log("check", check);
          this.startPlay();
        }
        ...
        processCorrect() {
          ...
          (_crd && scaleAndHide === void 0 ? (_reportPossibleCrUseOfscaleAndHide({
            error: Error()
          }), scaleAndHide) : scaleAndHide)(this.smile, v3(0.6, 0.6, 0), 3);
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "fireWorkL", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "fireWorkR", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "items", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=d84f8b1e6df00fd68fad81f87f2b24e06863d4eb.js.map