    ...
    execute: function () {
      ...
      _export("level4_science", level4_science = (_dec = ccclass('level4_science'), _dec2 = property(_crd && level_progress_bar === void 0 ? (_reportPossibleCrUseOflevel_progress_bar({
        ...
        onTouchStart(pUIStart) {
          ...
          var pStart = this.listDots[0].getWorldPosition();
          var dx = Math.abs(pStart.x - pUIStart.x);
          var dy = Math.abs(pStart.y - pUIStart.y);
...
//# sourceMappingURL=0c4420302986088e5e6f758c1d609cab75b72baf.js.map