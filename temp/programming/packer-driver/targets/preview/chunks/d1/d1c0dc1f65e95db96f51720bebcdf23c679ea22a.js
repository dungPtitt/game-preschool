System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, ProgressBar, Label, sys, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, ex_LoadingScreen2;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'ProgressBar', 'Label', 'sys']);
      ...
      _export("ex_LoadingScreen2", ex_LoadingScreen2 = (_dec = ccclass('ex_LoadingScreen2'), _dec2 = property(ProgressBar), _dec3 = property(Label), _dec(_class = (_class2 = class ex_LoadingScreen2 extends Component {
        ...
        _loadAudioWeb() {
          ...
          soundDirs.forEach(soundsPath => {
            var sounds = VDScreenManager.instance.assetBundle.getDirWithPath(soundsPath, AudioClip);
        ...
        _initAudio() {
          ...
          var isMuteMusic = VDLocalDataManager.getBoolean(VDAudioManager.ENABLE_MUSIC, false);
          var isMuteSfx = VDLocalDataManager.getBoolean(VDAudioManager.ENABLE_SFX, false);
        ...
        onClickBtn2MainGame() {
          ...
          var play_screen = VDScreenManager.instance.assetBundle.get('res/prefabs/screen/play_screen', Prefab);
...
//# sourceMappingURL=d1c0dc1f65e95db96f51720bebcdf23c679ea22a.js.map