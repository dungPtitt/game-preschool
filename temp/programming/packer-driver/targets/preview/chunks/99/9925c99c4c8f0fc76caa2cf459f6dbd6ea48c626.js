    ...
    execute: function () {
      ...
      _export("level2_science", level2_science = (_dec = ccclass('level2_science'), _dec2 = property({
        ...
        initGraphic() {
          ...
          var g = instantiate(graphicsPrefab);
          log("check draw: ", g.getComponent(Graphics), this.draw.getComponent(Graphics));
          this.graphics = g;
...
//# sourceMappingURL=9925c99c4c8f0fc76caa2cf459f6dbd6ea48c626.js.map