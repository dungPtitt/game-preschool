  ...
  return {
    ...
    execute: function () {
      ...
      _export("level1_match", level1_match = (_dec = ccclass('level1_match'), _dec2 = property({
        ...
        startPlay() {
          if (this.canPick) {
            for (var i = 0; i < this.itemQuestions.length; i++) {
              ...
              this.itemQuestions[i].on("i-am-moving", this.checkPosition.bind(this.itemQuestions[i], i));
            }
          }
        }
        ...
        checkPosition(itemMoving, i) {
          var questionP = itemMoving.getWorldPosition();
          log("check i: ", questionP); // for(let j = 0; j<this.itemAnswers.length; j++){
...
//# sourceMappingURL=964e6a709f794814ae36bba26eeb578ee382c0a6.js.map