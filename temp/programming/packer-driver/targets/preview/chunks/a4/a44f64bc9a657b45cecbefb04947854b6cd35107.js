System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, log, Prefab, tween, v3, Label, Button, UIOpacity, VDScreenManager, level_progress_bar, LocalDataManager, scaleAndHide, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, level1_science;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("level1_science", level1_science = (_dec = ccclass('level1_science'), _dec2 = property(Node), _dec3 = property({
        type: Node
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "fireWork", _descriptor, this);

          _initializerDefineProperty(this, "levelBarUI", _descriptor2, this);
        ...
        processCorrect(i) {
          ...
          this.listAnswer[i].getComponent(Button).onDisable();
        }
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "fireWork", [_dec2, _dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "levelBarUI", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=a44f64bc9a657b45cecbefb04947854b6cd35107.js.map