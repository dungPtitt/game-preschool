      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        processCorrect() {
          ...
          (_crd && scaleAndHide === void 0 ? (_reportPossibleCrUseOfscaleAndHide({
            error: Error()
          }), scaleAndHide) : scaleAndHide)(this.smile, v3(0.6, 0.6, 0), 2); // let sprite =  this.answer.getComponent();
...
//# sourceMappingURL=564c3be92206c15b181becf65018fb079c1c68e0.js.map