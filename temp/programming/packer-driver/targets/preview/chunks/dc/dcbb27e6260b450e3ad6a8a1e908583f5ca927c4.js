        ...
        checkAnswer() {
          if (this.canPlay) {
            ...
            if (dx < 40 && dy < 40) {
              ...
              this.isStart = false;
              this.listPosSrc.splice(this.idAnswer - 1, 1);
              this.ListPosDestination.splice(this.idAnswer - 1, 1);
              this.listAnswers[this.idAnswer].getComponent(Button).onDisable();
              log("correct!", this.listPosSrc); // xu ly doi net ve thanh duong thang mau do
...
//# sourceMappingURL=dcbb27e6260b450e3ad6a8a1e908583f5ca927c4.js.map