System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, log, Prefab, tween, v3, Label, Button, UIOpacity, VDScreenManager, level_progress_bar, LocalDataManager, scaleAndHide, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, level1_science;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("level1_science", level1_science = (_dec = ccclass('level1_science'), _dec2 = property({
        type: Node
      }), _dec3 = property({
        type: Node
      }), _dec4 = property({
        ...
        type: Node
      }), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = (_class2 = class level1_science extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "notAnswer", _descriptor, this);
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "notAnswer", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=dcaf724b146c7ea01996ec2b4bc8189064533980.js.map