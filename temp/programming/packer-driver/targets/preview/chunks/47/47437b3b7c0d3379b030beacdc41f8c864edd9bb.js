System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      LocalDataManager = _unresolved_6.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("ex_LoadingScreen2", ex_LoadingScreen2 = (_dec = ccclass('ex_LoadingScreen2'), _dec2 = property(ProgressBar), _dec3 = property(Label), _dec4 = property(Node), _dec(_class = (_class2 = class ex_LoadingScreen2 extends Component {
        ...
        onLoad() {
          ...
          var prefabs = ['res/prefabs/common/draw', 'res/prefabs/screen/main_screen', 'res/prefabs/screen/match_screen', 'res/prefabs/screen/match/level1', 'res/prefabs/screen/match/level2', 'res/prefabs/screen/match/level3', 'res/prefabs/screen/comparison_screen', 'res/prefabs/screen/comparison/level1', 'res/prefabs/screen/comparison/level2', 'res/prefabs/screen/comparison/level3', 'res/prefabs/screen/comparison/level4', 'res/prefabs/screen/comparison/level5', 'res/prefabs/screen/complete_picture_screen', 'res/prefabs/screen/complete_picture/level1', 'res/prefabs/screen/complete_picture/level2', // 'res/prefabs/screen/complete_picture/level3',
          'res/prefabs/screen/science_screen', 'res/prefabs/screen/science/level1', 'res/prefabs/screen/science/level2', 'res/prefabs/screen/science/level3', 'res/prefabs/screen/science/level4'];
        ...
        initCheck() {
          ...
          if (Object.keys(ob).length === 0) {
            (_crd && LocalDataManager === void 0 ? (_reportPossibleCrUseOfLocalDataManager({
              error: Error()
            }), LocalDataManager) : LocalDataManager).setObject("check", {
          ...
          log(">>", (_crd && LocalDataManager === void 0 ? (_reportPossibleCrUseOfLocalDataManager({
            error: Error()
          }), LocalDataManager) : LocalDataManager).getObject("check", {}));
        }
...
//# sourceMappingURL=47437b3b7c0d3379b030beacdc41f8c864edd9bb.js.map