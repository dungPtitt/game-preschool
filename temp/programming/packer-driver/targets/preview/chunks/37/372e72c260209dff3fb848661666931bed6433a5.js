  ...
  return {
    ...
    execute: function () {
      ...
      _export("level3_science", level3_science = (_dec = ccclass('level3_science'), _dec2 = property({
        ...
        error: Error()
      }), level_progress_bar) : level_progress_bar), _dec12 = property(Node), _dec(_class = (_class2 = class level3_science extends Component {
        constructor() {
          super(...arguments);
        ...
        initGraphic() {
          ...
          this.graphics.lineWidth = 10; // let g = this.graphics;
...
//# sourceMappingURL=372e72c260209dff3fb848661666931bed6433a5.js.map