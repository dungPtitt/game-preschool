  ...
  return {
    ...
    execute: function () {
      ...
      _export("level2_match", level2_match = (_dec = ccclass('level2_match'), _dec2 = property({
        ...
        startPlay() {
          if (this.canPick) {
            this.isTouchAnswers.length = this.listQuestions.length;
            this.isTouchQuestions.length = this.listQuestions.length;
...
//# sourceMappingURL=5fa74bb81e7ef7db8e9ac97615887bbea13c0257.js.map