  ...
  return {
    ...
    execute: function () {
      ...
      _export("level2_match", level2_match = (_dec = ccclass('level2_match'), _dec2 = property({
        ...
        checkSelected1(i) {
          log("check i: ", i); // khong the chon 2 cung mot the loai;

          if (this.idItemSelected1 == null) {
            this.idItemSelected1 = i; // this.checkQuestion(i);
          }
        }
        ...
        checkSelected2(i) {
          ...
          if (this.idItemSelected2 == null) {
            this.idItemSelected2 = i; // this.checkAnswer(i);
        ...
        //         this.numberSelect++;
        //         if(this.isTouchAnswers[i] && this.numberSelect==2){
        //             log("select correct!");
        //             this.numberSelect = 0;
        //             this.sum++;
        //         }else if(!this.isTouchAnswers[i] && this.numberSelect==2){
        //             log("seclect wrong!");
        //         }
        //     }else{
        //         this.isTouchQuestions[i] = false;
...
//# sourceMappingURL=5f55e0d1b2fd76cef52263978a1848343c3c1985.js.map