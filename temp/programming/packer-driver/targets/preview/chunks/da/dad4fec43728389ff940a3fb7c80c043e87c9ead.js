System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, log, assetManager, VDScreenManager, ex_Config, _dec, _class, _crd, ccclass, property, ex_Scence;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ex_Scence", ex_Scence = (_dec = ccclass('ex_Scence'), _dec(_class = class ex_Scence extends Component {
        onLoad() {
          log("@ dm_Scene: onLoad  !!!");
          var bundle = assetManager.getBundle("bundle_" + (_crd && ex_Config === void 0 ? (_reportPossibleCrUseOfex_Config({
            error: Error()
...
//# sourceMappingURL=dad4fec43728389ff940a3fb7c80c043e87c9ead.js.map