System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, instantiate, log, Graphics, level_progress_bar, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, level4_science;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("level4_science", level4_science = (_dec = ccclass('level4_science'), _dec2 = property(_crd && level_progress_bar === void 0 ? (_reportPossibleCrUseOflevel_progress_bar({
        ...
        start() {
          this.initGraphic();
          this.draw.on('draw-end', this.onTouchEnd.bind(this)); // this.draw.on(Node.EventType.TOUCH_MOVE, this.onTouchMove.bind(this));
...
//# sourceMappingURL=d03a4c50784cabddfdec8c99f71aeef58681c9f7.js.map