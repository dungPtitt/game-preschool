    ...
    execute: function () {
      ...
      _export("ex_MainScreen", ex_MainScreen = (_dec = ccclass('ex_MainScreen'), _dec(_class = class ex_MainScreen extends Component {
        onClickBtnLevelComparison() {
          ...
          var comparison_screen = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
        ...
        onClickCompletePicture() {
          var complete_picture_screen = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
...
//# sourceMappingURL=e94acd84c4be4778a21f2e6a956a1834e3a33aba.js.map