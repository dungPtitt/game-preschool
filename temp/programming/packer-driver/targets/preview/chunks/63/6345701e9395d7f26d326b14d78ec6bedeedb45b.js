System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Graphics, Vec2, v3, Color, _dec, _class, _crd, ccclass, property, temp_vec2, graphic_filling;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("graphic_filling", graphic_filling = (_dec = ccclass('graphic_filling'), _dec(_class = class graphic_filling extends Component {
        ...
        initGraphics() {
          var parentG = this.node.getParent();
        ...
        onTouchMove(event) {
          ...
          g.stroke();
          this.node.emit('draw-move');
        }

        onTouchEnd() {
          this.node.emit('draw-end');
        }
...
//# sourceMappingURL=6345701e9395d7f26d326b14d78ec6bedeedb45b.js.map