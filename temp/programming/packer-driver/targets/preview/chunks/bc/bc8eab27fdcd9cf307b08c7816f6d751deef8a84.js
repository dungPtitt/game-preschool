          ...
          for (var j = 0; j < this.itemQuestion.length; j++) {
            ...
            if (dx < 40 && dy < 40) {
              if (i == j) {
                ...
                var spriteA = this.itemQuestion[i].getComponent(Sprite);
                var spriteQ = this.itemAnswer[i].getComponent(Sprite);
...
//# sourceMappingURL=bc8eab27fdcd9cf307b08c7816f6d751deef8a84.js.map