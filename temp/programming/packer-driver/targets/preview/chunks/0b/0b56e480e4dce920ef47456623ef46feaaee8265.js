  ...
  return {
    ...
    execute: function () {
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        type: Node
      }), _dec8 = property(_crd && level_progress_bar === void 0 ? (_reportPossibleCrUseOflevel_progress_bar({
        error: Error()
      }), level_progress_bar) : level_progress_bar), _dec9 = property({
        type: Node
      }), _dec10 = property(Node), _dec(_class = (_class2 = class level1_comp extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "levelBarUI", _descriptor7, this);
        ...
        onClickBtnNext(event, data) {
          this.onClickBtnShowPopup();
          log("check number: ", data); // let level2_screen = VDScreenManager.instance.assetBundle.get('res/prefabs/screen/comparison/level'+String(data), Prefab)!;
        ...
        start() {
          ...
          this.levelNumber = Number(lev); // let checkDone = LocalDataManager.getObject("check", {});
        ...
        processCorrect() {
          ...
          var checkDone = ob.comparison[this.levelNumber];
          ...
          (_crd && scaleAndHide === void 0 ? (_reportPossibleCrUseOfscaleAndHide({
            error: Error()
          }), scaleAndHide) : scaleAndHide)(this.fireWork, v3(1, 1, 0), 3, this.onClickBtnShowPopup);
        ...
        onClickBtnShowPopup() {
          (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            ...
            (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
              error: Error()
            }), VDScreenManager) : VDScreenManager).instance.pushScreen(level2_screen, screen => {}, true); // popupWin.finishedCallback = () => {
            //     log(' Just Closed Popup !!!', String(this.levelNumber));
            //     let level2_screen = VDScreenManager.instance.assetBundle.get('res/prefabs/screen/comparison/level'+String(this.levelNumber), Prefab)!;
            //     VDScreenManager.instance.pushScreen(level2_screen, (screen: VDBaseScreen) => { }, true); 
            // };
          }, false, true, true);
        }
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "levelBarUI", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=0b56e480e4dce920ef47456623ef46feaaee8265.js.map