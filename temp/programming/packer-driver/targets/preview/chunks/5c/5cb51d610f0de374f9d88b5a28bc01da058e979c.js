System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, log, Prefab, Button, UIOpacity, VDScreenManager, LocalDataManager, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, ex_complete_picture;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ffeb5p5ZyZKQpN2KXX+p8WS", "ex_CompletePicture", undefined);
      ...
      _export("ex_complete_picture", ex_complete_picture = (_dec = ccclass('ex_complete_picture'), _dec2 = property(Node), _dec(_class = (_class2 = class ex_complete_picture extends Component {
        constructor() {
          super(...arguments);
        ...
        onClickBtnLevel1() {
          var play_screen = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
          }), VDScreenManager) : VDScreenManager).instance.assetBundle.get('res/prefabs/screen/complete_picture/level1', Prefab);
          (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
        ...
        onClickBtnLevel2() {
          var play_screen = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
          }), VDScreenManager) : VDScreenManager).instance.assetBundle.get('res/prefabs/screen/complete_picture/level2', Prefab);
          (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
          }), VDScreenManager) : VDScreenManager).instance.pushScreen(play_screen, screen => {}, true);
        }
        ...
        canPlayLevel() {
          ...
          var checkDone = ob.picture; //co the dung do dai cua listLevel or checkDone
...
//# sourceMappingURL=5cb51d610f0de374f9d88b5a28bc01da058e979c.js.map