        ...
        checkAnswer() {
          if (this.canPlay) {
            ...
            if (dx < 50 && dy < 50) {
              ...
              var g = this.graphics;
              g.clear(); // g.strokeColor = Color.RED;

              g.moveTo(this.pSrc.x, this.pSrc.y);
              g.lineTo(this.pTarget.x, this.pTarget.y);
              g.stroke();
            }
          }
        }
...
//# sourceMappingURL=ecf6c98d484858c91d05e58ce96bf78d78e52f8b.js.map