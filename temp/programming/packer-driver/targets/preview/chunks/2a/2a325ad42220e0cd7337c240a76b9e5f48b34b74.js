    ...
    execute: function () {
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        processCorrect() {
          ...
          var checkDone = ob.comparison[this.levelNumber + 1];
          ...
          (_crd && scaleTo2 === void 0 ? (_reportPossibleCrUseOfscaleTo2({
            error: Error()
          }), scaleTo2) : scaleTo2)(this.answer, v3(1.2, 1.2, 0), 2); // let sprite =  this.answer.getComponent();
...
//# sourceMappingURL=2a325ad42220e0cd7337c240a76b9e5f48b34b74.js.map