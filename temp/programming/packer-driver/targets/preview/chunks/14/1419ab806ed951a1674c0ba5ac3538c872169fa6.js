    ...
    execute: function () {
      ...
      _export("ex_LoadingScreen", ex_LoadingScreen = (_dec = ccclass('ex_LoadingScreen'), _dec(_class = class ex_LoadingScreen extends Component {
        ...
        onLoad() {
          ...
          var prefabs = ['res/prefabs/screen/match', 'res/prefabs/screen/match/level1', 'res/prefabs/screen/level_comparison_screen', 'res/prefabs/screen/level1'];
        ...
        onClickMatchScreen() {
          log("on click match screen"); // let match_screen = VDScreenManager.instance.assetBundle.get('res/prefabs/screen/match', Prefab)!;
...
//# sourceMappingURL=1419ab806ed951a1674c0ba5ac3538c872169fa6.js.map