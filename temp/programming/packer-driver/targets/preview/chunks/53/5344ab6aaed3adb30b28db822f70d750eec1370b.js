    ...
    execute: function () {
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        start() {
          ...
          this.levelNumber = Number(lev); // let btn = this.btnHome.getComponent(Button);

          log("check btn", this.btnHome); // btn.onDisable;
...
//# sourceMappingURL=5344ab6aaed3adb30b28db822f70d750eec1370b.js.map