    ...
    execute: function () {
      ...
      _export("default", VDTabbar = (_dec = property(cc.Node), _dec2 = property(cc.Node), _dec3 = property(cc.CCInteger), ccclass(_class = (_class2 = class VDTabbar extends cc.Component {
        ...
        onLoad() {
          ...
          for (var child of this.tabbar.children) {
            if (child.active) {
              var com = child.getComponent(_crd && VDTabbarItem === void 0 ? (_reportPossibleCrUseOfVDTabbarItem({
                error: Error()
              }), VDTabbarItem) : VDTabbarItem);

              if (com) {
                var t = child.getComponent(cc.Button);
        ...
        selectItemAtIndex(idx) {
          ...
          if (this._curSelectedIndex != idx) {
            ...
            if (selectedItem.content && selectedItem.content.parent) {
              ...
              this.content.addChild(selectedItem.content);
              var widget = selectedItem.content.getComponent(cc.Widget);
...
//# sourceMappingURL=cc3f1572a02cb62d69d339195bc15fc3bb5a8c50.js.map