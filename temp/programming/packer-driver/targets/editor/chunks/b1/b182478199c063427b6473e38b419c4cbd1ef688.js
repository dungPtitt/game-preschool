System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, instantiate, log, Graphics, v3, level_progress_bar, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, level4_science;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Prefab', 'instantiate', 'log', 'Gradient', 'Graphics', 'EventTouch', 'v3']);
      ...
      _export("level4_science", level4_science = (_dec = ccclass('level4_science'), _dec2 = property(_crd && level_progress_bar === void 0 ? (_reportPossibleCrUseOflevel_progress_bar({
        ...
        initGraphic() {
          ...
          let nodeG = this.draw;
          log("check draw: ", this.draw);
          this.graphics = nodeG.getComponent(Graphics);
          let g = this.graphics;
          g.lineWidth = 10; // this.graphics = 
        }
...
//# sourceMappingURL=b182478199c063427b6473e38b419c4cbd1ef688.js.map