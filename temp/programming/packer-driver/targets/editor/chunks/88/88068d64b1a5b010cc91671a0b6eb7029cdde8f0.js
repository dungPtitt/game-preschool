System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, log, tween, v3, Label, Button, UIOpacity, VDScreenManager, LocalDataManager, level_progress_bar, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, level3_comp;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("level3_comp", level3_comp = (_dec = ccclass('level3_comp'), _dec2 = property({
        type: Node
      }), _dec3 = property({
        type: Node
        ...
        type: Node
      }), _dec(_class = (_class2 = class level3_comp extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "cryIcon", _descriptor6, this);
        ...
        checkSelected2(i) {
          if (this.idItemSelected2 == null) {
            ...
            //chon cung loai trong list coi la sai
            log("chon loai khac!");
            this.handleWrong();
            this.cancelSelect2(i);
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "cryIcon", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=88068d64b1a5b010cc91671a0b6eb7029cdde8f0.js.map