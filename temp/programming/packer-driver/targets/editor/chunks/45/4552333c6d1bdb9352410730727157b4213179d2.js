System.register(["cc"], function (_export, _context) {
  ...
  function scaleTo(node, factor1, factor2, duration, callback) {
    tween(node).to(duration, {
      ...
      scale: ScaleFactor.EQUAL
    }).repeat(3).call(callback).start();
  }

  function scaleTo2(node, factor, duration, callback) {
    tween(node).to(duration, {
      scale: factor
    }).call(callback).start();
  }

  function scaleAndHide(node, factor, duration, callback) {
    tween(node).to(duration, {
      scale: factor
    }).call(() => {
      node.active = false;
...
//# sourceMappingURL=4552333c6d1bdb9352410730727157b4213179d2.js.map