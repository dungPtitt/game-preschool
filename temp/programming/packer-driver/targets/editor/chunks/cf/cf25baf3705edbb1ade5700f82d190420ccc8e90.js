  ...
  return {
    ...
    execute: function () {
      ...
      _export("level2_picture", level2_picture = (_dec = ccclass('level2_picture'), _dec2 = property({
        ...
        startPlay() {
          ...
          if (this.canPick) {
            for (let i = 0; i < this.itemAnswer.length; i++) {
              ...
              let p = this.itemAnswer[i].getWorldPosition();
        ...
        checkPosition(i) {
          let questionP = this.itemAnswer[i].getWorldPosition(); // log("check i: ",i);

          for (let j = 0; j < this.itemQuestion.length; j++) {
            let answerP = this.itemQuestion[j].getWorldPosition();
            ...
            if (dx < 40 && dy < 40) {
              if (i == j) {
                ...
                let spriteA = this.itemQuestion[i].getComponent(Sprite);
        ...
        handleCorrect() {
          ...
          obCheck.match[this.levelNumber] = true;
...
//# sourceMappingURL=cf25baf3705edbb1ade5700f82d190420ccc8e90.js.map