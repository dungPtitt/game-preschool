  ...
  return {
    ...
    execute: function () {
      ...
      _export("level2_science", level2_science = (_dec = ccclass('level2_science'), _dec2 = property({
        ...
        initGraphic() {
          let graphicsPrefab = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
          ...
          this.draw = gNode;
          let g = instantiate(graphicsPrefab).getComponent(Graphics); // log("check draw: ", g.getComponent(Graphics), this.draw.getComponent(Graphics));
...
//# sourceMappingURL=5997a1c6df1b17ef546887dc527eff7c5a2783a6.js.map