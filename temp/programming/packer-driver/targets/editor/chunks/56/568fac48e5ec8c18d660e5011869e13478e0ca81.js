System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Graphics, v3, log, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, level1_science;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Graphics', 'EventTouch', 'v3', 'Vec3', 'log']);
      ...
      _export("level1_science", level1_science = (_dec = ccclass('level1_science'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec(_class = (_class2 = class level1_science extends Component {
        ...
        touchMove(event) {
          ...
          log("check p", newP); // this.checkCorrect(newP);
...
//# sourceMappingURL=568fac48e5ec8c18d660e5011869e13478e0ca81.js.map