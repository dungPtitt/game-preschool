    ...
    execute: function () {
      ...
      _export("level2_science", level2_science = (_dec = ccclass('level2_science'), _dec2 = property({
        ...
        onTouchEnd(event) {
          ...
          if (dx > 40 || dy > 40) {
            log("draw again!");
            this.pTemp = v2(this.pStart.x, this.pStart.y); // this.drawAgain();
          } else {
            log("draw continue!");
            this.pTemp = v2(p.x, p.y);
            let g = this.graphics;
            g.moveTo(this.pDrawStart.x, this.pDrawStart.y);
            g.lineTo(this.pStart.x, this.pStart.y);
            g.stroke();
          }
        }
...
//# sourceMappingURL=565525c0c328a9f20d8a5086c7b1ff4d1f38dc24.js.map