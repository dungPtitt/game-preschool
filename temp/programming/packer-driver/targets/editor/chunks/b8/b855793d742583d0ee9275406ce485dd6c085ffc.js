    ...
    execute: function () {
      ...
      _export("level1_match", level1_match = (_dec = ccclass('level1_match'), _dec2 = property({
        ...
        checkPosition(itemMoving, i) {
          ...
          for (let j = 0; j < this.itemAnswers.length; j++) {// let answerP = this.itemAnswers[i].getWorldPosition();
...
//# sourceMappingURL=b855793d742583d0ee9275406ce485dd6c085ffc.js.map