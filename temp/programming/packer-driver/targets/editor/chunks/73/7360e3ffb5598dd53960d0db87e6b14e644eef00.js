System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, log, Sprite, VDScreenManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, level1_match;
          ...
          for (let j = 0; j < this.itemAnswers.length; j++) {
            ...
            if (dx < 40 && dy < 40) {
              if (i == j) {
                ...
                let spriteQ = this.itemAnswers[i].getComponent(Sprite);
                log("correct!");
              } else {
                log("wrong!");
              }
...
//# sourceMappingURL=7360e3ffb5598dd53960d0db87e6b14e644eef00.js.map