    ...
    execute: function () {
      ...
      _export("level1_comp", level1_comp = (_dec = ccclass('level1_comp'), _dec2 = property({
        ...
        start() {
          ...
          this.canPlay = !check; // let check = LocalDataManager.getObject("check", {});
        ...
        processCorrect() {
          let check = (_crd && LocalDataManager === void 0 ? (_reportPossibleCrUseOfLocalDataManager({
            error: Error()
          }), LocalDataManager) : LocalDataManager).getObject("check", {});
...
//# sourceMappingURL=30ff388b1a0eeae6a7c7ab8c33b23edc2e85898d.js.map