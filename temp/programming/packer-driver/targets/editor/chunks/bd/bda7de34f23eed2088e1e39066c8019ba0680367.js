    ...
    execute: function () {
      ...
      _export("level1_science", level1_science = (_dec = ccclass('level1_science'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class level1_science extends Component {
        ...
        initGraphic() {
          ...
          let startP = this.left.getPosition();
          let endP = this.right.getPosition(); // log("check endP", endP, startP);
        ...
        touchStart(event) {
          let startP = this.left.getPosition();
          let endP = this.right.getPosition();
...
//# sourceMappingURL=bda7de34f23eed2088e1e39066c8019ba0680367.js.map