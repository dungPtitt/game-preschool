System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Sprite', 'Color', 'log', 'Prefab', 'tween', 'v3', 'Label', 'Vec3', 'Button', 'UIOpacity', 'EventTouch', 'Graphics', 'v2']);
      ...
      _export("level2_science", level2_science = (_dec = ccclass('level2_science'), _dec2 = property({
        ...
        error: Error()
      }), level_progress_bar) : level_progress_bar), _dec10 = property(Node), _dec(_class = (_class2 = class level2_science extends Component {
        constructor(...args) {
          super(...args);
        ...
        onTouchStart(event) {
          ...
          let g = this.graphics;
          g.moveTo(out.x, out.y); // g.lineTo(out.x, out.y);
          // g.stroke();
        }
...
//# sourceMappingURL=676306522b5e0698fcf9ad683a9c748fcf1b7c63.js.map