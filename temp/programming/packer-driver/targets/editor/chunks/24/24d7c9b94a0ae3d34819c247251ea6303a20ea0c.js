      ...
      _export("level3_science", level3_science = (_dec = ccclass('level3_science'), _dec2 = property({
        ...
        onTouchStart(event) {
          if (this.firstOne) {
            ...
            for (let i = 0; i < this.listAnswers.length; i++) {
              let pLeft = this.listPosSrc[i].getWorldPosition();
              this.listPosSrc[i] = v2(pLeft.x, pLeft.y);
            } // gan vi tri dich


            for (let i = 0; i < this.listQuestion.length; i++) {
              let pRight = this.ListPosDestination[i].getWorldPosition();
              this.listPosSrc[i] = v2(pRight.x, pRight.y);
            }
        ...
        checkStart() {
          for (let i = 0; i < this.listPosSrc.length; i++) {
            ...
            let dy = Math.abs(this.listPosSrc[i].x - this.pDrawStart.y);
...
//# sourceMappingURL=24d7c9b94a0ae3d34819c247251ea6303a20ea0c.js.map