System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, ProgressBar, Label, sys, log, assetManager, AudioClip, Prefab, VDAudioManager, VDLocalDataManager, VDScreenManager, ex_Config, ex_Director, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, ex_LoadingScreen2;
  ...
  function _reportPossibleCrUseOfex_MainScreen(extras) {
    _reporterNs.report("ex_MainScreen", "./ex_MainScreen", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ex_Director = _unresolved_6.ex_Director;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("ex_LoadingScreen2", ex_LoadingScreen2 = (_dec = ccclass('ex_LoadingScreen2'), _dec2 = property(ProgressBar), _dec3 = property(Label), _dec(_class = (_class2 = class ex_LoadingScreen2 extends Component {
        ...
        onLoad() {
          ...
          let prefabs = ['res/prefabs/screen/match', 'res/prefabs/screen/match/level1', 'res/prefabs/screen/level_comparison_screen', 'res/prefabs/screen/comparison/level1'];
...
//# sourceMappingURL=749096408e10c957665fcbba954aa43af55a0da2.js.map