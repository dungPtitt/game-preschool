    ...
    execute: function () {
      ...
      _export("level1_match", level1_match = (_dec = ccclass('level1_match'), _dec2 = property({
        ...
        checkPosition(itemMoving, i) {
          ...
          for (let j = 0; j < this.itemAnswers.length; j++) {// let answerP = this.itemAnswers[j].getWorldPosition();
...
//# sourceMappingURL=664f289af60e25eac641230cafb09cb0b4ba8e39.js.map