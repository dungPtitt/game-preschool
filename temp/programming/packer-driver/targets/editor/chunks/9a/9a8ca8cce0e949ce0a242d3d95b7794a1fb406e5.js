System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Prefab, log, VDScreenManager, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, level1_picture;
    ...
    execute: function () {
      ...
      _export("level1_picture", level1_picture = (_dec = ccclass('level1_picture'), _dec2 = property({
        ...
        checkPosition(i) {
          ...
          log("check i: ", this.answer.getWorldPosition()); // for(let j = 0; j<this.itemAnswers.length; j++){
...
//# sourceMappingURL=9a8ca8cce0e949ce0a242d3d95b7794a1fb406e5.js.map