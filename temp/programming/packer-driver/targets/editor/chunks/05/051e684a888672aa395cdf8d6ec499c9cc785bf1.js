  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", VDScreenManager = ccclass(_class = (_class2 = class VDScreenManager extends cc.Component {
        ...
        pushScreen(screen, callback, animated = false, zIndex = VD_ZINDEX.SCREEN) {
          let self = this;
          ...
          if (this._screenStack.length != 0) {
            ...
            this.loadScreen(screen, function (nextScreen) {
              ...
              let touchHandler = nextScreen.getComponent(cc.Button);
        ...
        popScreen(animated = false, showWaiting = true) {
        ...
        popToRootScreen(animated = false) {
        ...
        popToScreen(classNameOrComponent, animated = false) {
          let screenIdx = -1;
        ...
        popToScreenAtIndex(screenIdx, animated = false, showWaiting = true) {
          if (this._animating || this._screenStack.length <= 1) {
            return null;
          }
        ...
        replaceScreenAtIndex(screen, screenIdx, callback, animated = false, zIndex = VD_ZINDEX.SCREEN, showWaiting = true) {
        ...
        removePopupNode(node, animated = true) {
        ...
        removePopup(popup, animated = true) {
              ...
              cc.tween(uiOpacity).to(0.25, {
                ...
                onUpdate: (target, ratio) => {
                  popup.node.walk(child => {
                    let spine = child.getComponent(cc.sp.Skeleton);

                    if (spine) {
                      let color = cc.Color.clone(spine.color);
        ...
        showPopupFromPrefabName(resPath, callback = null, hideWhenTouchOnBackground = true, animated = true, showBackgroundLayer = true) {
        ...
        showPopupFromPrefab(prefab, callback = null, hideWhenTouchOnBackground = true, animated = true, showBackgroundLayer = true) {
          if (!prefab) {
            return;
          }
        ...
        showPopupFromNode(nodePopup, callback = null, hideWhenTouchOnBackground = true, animated = true, showBackgroundLayer = true) {
          if (!nodePopup) {
            return;
          }
          ...
          let popComp = nodePopup.getComponent(_crd && VDBasePopup === void 0 ? (_reportPossibleCrUseOfVDBasePopup({
            error: Error()
          }), VDBasePopup) : VDBasePopup);
        ...
        showEffect(fxNode, animationName = "", completedCallback = null) {
...
//# sourceMappingURL=051e684a888672aa395cdf8d6ec499c9cc785bf1.js.map