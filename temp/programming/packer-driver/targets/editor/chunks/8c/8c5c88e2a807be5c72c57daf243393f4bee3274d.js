    ...
    execute: function () {
      ...
      _export("ex_LoadingScreen", ex_LoadingScreen = (_dec = ccclass('ex_LoadingScreen'), _dec(_class = class ex_LoadingScreen extends Component {
        ...
        onLoad() {
          ...
          let prefabs = ['res/prefabs/screen/match', 'res/prefabs/screen/level_comparison_screen', 'res/prefabs/screen/level1'];
        ...
        onClickMatchScreen() {
          let match_screen = (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
          }), VDScreenManager) : VDScreenManager).instance.assetBundle.get('res/prefabs/screen/match', Prefab);
          (_crd && VDScreenManager === void 0 ? (_reportPossibleCrUseOfVDScreenManager({
            error: Error()
          }), VDScreenManager) : VDScreenManager).instance.pushScreen(match_screen, screen => {}, true); // let play_screen = VDScreenManager.instance.assetBundle.get('res/prefabs/screen/level_comparison_screen', Prefab)!;
...
//# sourceMappingURL=8c5c88e2a807be5c72c57daf243393f4bee3274d.js.map